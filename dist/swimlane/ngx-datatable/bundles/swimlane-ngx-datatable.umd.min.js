!(function (e, t) {
    ...
    if (e) {
      ...
      try {
        for (var o = h(e), i = o.next(); !i.done; i = o.next()) {
          var a = i.value;
          a.$$id || (a.$$id = z()),
            j(a.prop) && a.name && (a.prop = _(a.name)),
            a.$$valueGetter || (a.$$valueGetter = x(a.prop)),
            !j(a.prop) && j(a.name) && (a.name = O(String(a.prop))),
            j(a.prop) && j(a.name) && (a.name = ''),
  ...
  ((R = e.ColumnMode || (e.ColumnMode = {})).standard = 'standard'),
    (R.flex = 'flex'),
    (R.force = 'force'),
    ((H = e.SelectionType || (e.SelectionType = {})).single = 'single'),
    (H.multi = 'multi'),
    (H.multiClick = 'multiClick'),
    (H.cell = 'cell'),
    (H.checkbox = 'checkbox'),
    ((D = e.SortType || (e.SortType = {})).single = 'single'),
    (D.multi = 'multi'),
  ...
  (B.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-header-template]' }] }]),
    (B.ctorParameters = function () {
      return [{ type: t.TemplateRef }];
    });
  var W = function (e) {
  ...
  (V.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-column' }] }]),
    ...
    (V.propDecorators = {
      ...
      _headerTemplateQuery: [{ type: t.ContentChild, args: [B, { read: t.TemplateRef, static: !0 }] }],
  ...
  (L.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-row-detail-template]' }] }]),
    (L.ctorParameters = function () {
      return [{ type: t.TemplateRef }];
    });
  var G = (function () {
  ...
  (G.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-row-detail' }] }]),
    (G.propDecorators = {
      rowHeight: [{ type: t.Input }],
      _templateInput: [{ type: t.Input, args: ['template'] }],
      _templateQuery: [{ type: t.ContentChild, args: [L, { read: t.TemplateRef, static: !0 }] }],
      toggle: [{ type: t.Output }]
    });
  var $ = (function () {
    function e() {}
  ...
  ($.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-footer' }] }]),
    ($.propDecorators = {
  ...
  var ce = (function () {
    ...
    return (
      Object.defineProperty(e.prototype, 'setGroupHeader', {
        set: function (e) {
          (this.groupHeader = e), this.groupHeader && !this.listener && this.setGroupHeaderListener();
        },
        enumerable: !1,
        configurable: !0
      }),
      ...
      (e.prototype.ngOnInit = function () {
        ...
        this.rowDetail &&
          ...
          this.groupHeader && this.setGroupHeaderListener();
      }),
      (e.prototype.setGroupHeaderListener = function () {
        var e = this;
      ...
      (e.prototype.toggleRowExpansion = function (e) {
        ...
        r ? this.rowExpansions.splice(n, 1) : this.rowExpansions.push(e),
          (this.isAllGroupCollapsed = 0 === this.rowExpansions.length),
      ...
      (e.prototype.getRowExpanded = function (e) {
        var t, n;
        if (0 === this.rowExpansions.length && this.groupExpansionDefault && !this.isAllGroupCollapsed)
          try {
  ...
  (ce.decorators = [
    ...
    (ce.propDecorators = {
      ...
      setGroupHeader: [{ type: t.Input, args: ['groupHeader'] }],
  ...
  function ye(e, t, n, r, o, i) {
    var a, s, l, c;
    void 0 === o && (o = 300), void 0 === i && (i = 0);
    var u = e.slice(n + 1, e.length).filter(function (e) {
      return !1 !== e.canAutoResize;
    });
    try {
      for (var p = h(u), d = p.next(); !d.done; d = p.next()) {
        (x = d.value).$$oldWidth || (x.$$oldWidth = x.width);
      }
    } catch (e) {
      a = { error: e };
    } finally {
    ...
    do {
      (g = m / u.length), (f = y >= t);
      try {
        for (var w = ((l = void 0), h(u)), v = w.next(); !v.done; v = w.next()) {
          var x = v.value;
          if (f && r) x.width = x.$$oldWidth || x.width || o;
          else {
            var C = (x.width || o) + g;
            x.minWidth && C < x.minWidth
              ? ((x.width = x.minWidth), b.push(x))
              : x.maxWidth && C > x.maxWidth
              ? ((x.width = x.maxWidth), b.push(x))
              : (x.width = C);
          }
          x.width = Math.max(0, x.width);
        }
      } catch (e) {
        l = { error: e };
      } finally {
      ...
      (m = t - (y = be(e))), me(u, b);
    } while (m > 1 && 0 !== u.length);
    Math.abs(m) > 1 && i < 5 && ye(e, t, n, r, o, i + 1);
  }
  function me(e, t) {
    var n, r;
    try {
  ...
  var Ce = (function () {
    ...
    return (
        ...
        set: function (e) {
          ...
          (this._rows = e),
            ...
            this._rows &&
              ...
              this.groupedRows.forEach(function (e) {
                e.value = T(e.value, P(t.treeFromRelation), P(t.treeToRelation));
              })),
      ...
      Object.defineProperty(n.prototype, 'columns', {
        ...
        set: function (e) {
          e && ((this._internalColumns = g(e)), M(this._internalColumns), this.recalculateColumns()),
            (this._columns = e);
        },
        enumerable: !1,
        configurable: !0
      ...
      (n.prototype.translateColumns = function (e) {
        if (e) {
          var t = e.toArray();
          t.length &&
            ((this._internalColumns = A(t)),
            M(this._internalColumns),
      ...
      (n.prototype.onHeaderSelect = function (e) {
        ...
        if (this.bodyComponent && this.selectAllRowsOnPage) {
          var r = this.bodyComponent.indexes.first,
            ...
            i =
              this.selectCheck && 'function' == typeof this.selectCheck
                ? this._internalRows.slice(r, o).filter(this.selectCheck.bind(this))
                : this._internalRows.slice(r, o),
            a = this.selected.length === i.length;
          (this.selected = []), a || (t = this.selected).push.apply(t, g(i));
        } else {
          (i =
            this.selectCheck && 'function' == typeof this.selectCheck
              ...
              : this.rows),
            (a = this.selected.length === i.length);
          (this.selected = []), a || (n = this.selected).push.apply(n, g(i));
        }
  ...
  (Ce.decorators = [
    ...
    (Ce.propDecorators = {
      ...
      rowDetail: [{ type: t.ContentChild, args: [G] }],
      groupHeader: [{ type: t.ContentChild, args: [w] }],
      footer: [{ type: t.ContentChild, args: [$] }],
  ...
  var Pe = (function () {
    function e() {
      (this.showLastPage = !0),
        (this.change = new t.EventEmitter()),
        (this._count = 0),
        (this._page = 1),
        (this._size = 0);
    }
    ...
    return (
      (n.prototype.selectRow = function (t, n, r) {
        ...
        if (this.selectEnabled) {
          if (t instanceof MouseEvent && 'click' === t.type && t.composedPath())
            for (var i = t.composedPath(), a = 0; !i[a].localName.startsWith('datatable-') && a < i.length; a++)
              if ('button' === i[a].localName || 'a' === i[a].localName) return;
          var s = this.selectionType === e.SelectionType.checkbox,
            l = this.selectionType === e.SelectionType.multi,
            c = this.selectionType === e.SelectionType.multiClick,
            u = [];
          (u =
            l || s || c
              ? t.shiftKey
                ? _e([], this.rows, n, this.prevIndex, this.getRowSelectedIdx.bind(this))
                : t.ctrlKey || t.metaKey || c || s
                ? ke(g(this.selected), r, this.getRowSelectedIdx.bind(this))
                : ke([], r, this.getRowSelectedIdx.bind(this))
              : ke([], r, this.getRowSelectedIdx.bind(this))),
            'function' == typeof this.selectCheck && (u = u.filter(this.selectCheck.bind(this))),
            this.selected.splice(0, this.selected.length),
            (o = this.selected).push.apply(o, g(u)),
            (this.prevIndex = n),
            this.select.emit({ selected: u });
        }
      }),
  ...
  var je = (function () {
    ...
    return (
      ...
      (e.prototype.getSummaryFunction = function (e) {
        return void 0 === e.summaryFunc ? ze : null === e.summaryFunc ? Me : e.summaryFunc;
      }),
      e
    );
  })();
  ...
  (Be.decorators = [
      ...
      args: [
        {
          ...
          exports: [Ce, G, w, L, V, B, W, F, l, $, Pe, b]
        }
      ]
    }
  ]),
    ((Ae = e.ClickType || (e.ClickType = {})).single = 'single'),
    (Ae.double = 'double'),
    ...
    (e.DataTableRowWrapperComponent = De),
    (e.DataTableSelectionComponent = Oe),
    (e.DataTableSummaryRowComponent = je),
    (e.DatatableComponent = Ce),
    (e.DatatableFooterDirective = $),
    (e.DatatableGroupHeaderDirective = w),
    (e.DatatableGroupHeaderTemplateDirective = b),
    (e.DatatableRowDetailDirective = G),
    (e.DatatableRowDetailTemplateDirective = L),
    (e.DimensionsHelper = a),
    (e.DraggableDirective = u),
    (e.LongPressDirective = y),
    (e.NgxDatatableModule = Be),
    ...
    (e.selectRows = ke),
    (e.selectRowsBetween = _e),
    (e.setColumnDefaults = M),
    (e.shallowValueGetter = I),
    (e.sortRows = xe),
    (e.throttle = he),
    (e.throttleable = de),
    (e.translateTemplates = A),
    (e.translateXY = le),
    (e.ɵ0 = J),
